...
/** Fires up a Jetty instance, and creates two Servlets: One using ordinary sync Servlet handling, the other async. */
public class SimpleServiceHttpServer {
    public static void main(String... args) {
        MatsExampleJettyServer.create(8080, SimpleServiceHttpServer.class)
                .addMatsInitScl() // Includes a ServletContextListener taking up a MatsFactory and MatsFuturizer.
                .setRootHtlm("""
                        <html><body>
                        <h1>Basic Servlet MatsFuturizer Example, sync and async, sequentially issued.</h1>
                        <h3>Single, simple futurization:</h3>
                        <a href="initiate_simple?count=1000">Sync Servlet handling, 1000 calls</a><p>
    ...
    public static class InitiateServlet_Simple extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            try {
                resp.getWriter().println("Got reply: " + replyFuture.get(30, TimeUnit.SECONDS));
            }
    ...
    public static class InitiateServlet_Sync_Multi extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            out.println("Initiating sync " + count + " concurrent futurizations");
            out.flush();
    ...
    public static class InitiateServlet_Async_Multi extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            ...
            PrintWriter out = resp.getWriter();
            out.println("Initiating async " + count + " concurrent futurizations");
            out.flush();
